      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-800 leading-tight">
            ...
            <span className="text-blue-700">Government Job</span>
          </h1>
          ...
          <div className="flex gap-6 mt-5 text-xs text-gray-700">
            <div className="flex items-center gap-1">
              ...
              <div>
                <div className="font-bold text-base text-gray-800">50K+</div>
            ...
            <div className="flex items-center gap-1">
              <span className="text-lg">📊</span>
              <div>
                <div className="font-bold text-base text-gray-800">100K+</div>
            ...
            <div className="flex items-center gap-1">
              <span className="text-lg">👥</span>
              <div>
                <div className="font-bold text-base text-gray-800">10M+</div>
            ...
            <div className="flex items-center gap-1">
              <span className="text-lg">🔔</span>
              <div>
                <div className="font-bold text-base text-gray-800">Daily</div>
        ...
        <div className="bg-white rounded-xl shadow p-5">
          <div className="flex gap-2 mb-4 text-xs font-semibold">
            <button className="bg-blue-700 text-white px-3 py-1.5 rounded">🔍 Search Jobs</button>
            <button className="text-gray-500 px-3 py-1.5 rounded border border-gray-300 hover:bg-gray-50">🔍 Search Results</button>
            <button className="text-gray-500 px-3 py-1.5 rounded border border-gray-300 hover:bg-gray-50">🔍 Admit Card</button>
          </div>
          ...
          <div className="flex gap-2 mb-4">
            ...
            />
            <button className="bg-blue-700 text-white px-4 py-2 rounded text-sm hover:bg-blue-600">Search</button>
          </div>
          ...
          <button className="w-full bg-blue-700 text-white py-2 rounded text-sm font-semibold hover:bg-blue-600">
            🔍 Find My Jobs
          </button>
        </div>
